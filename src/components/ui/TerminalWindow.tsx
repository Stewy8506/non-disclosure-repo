...
export default function TerminalWindow() {
  ...
  const windowData = useWindowStore((state) => state.windows["terminal"]);
  ...
  return (
    <AppWindow id="terminal" defaultWidth={700} defaultHeight={450}>
      <div
        className="flex-1 flex flex-col h-full bg-zinc-950 font-mono w-full"
